...
@section('title', 'Crafting - HarunGamingTools')

@section('content')
<div style="text-align:center;padding:80px 20px;">
    <div style="font-size:3rem;margin-bottom:16px;">🛠️</div>
    <h1 style="font-family:'Fraunces',serif;color:var(--gold);font-size:1.4rem;margin-bottom:10px;">Crafting</h1>
